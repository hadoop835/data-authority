...
public abstract class PluginUtils {
    ...
    public static MybatisStatementHandler mybatisStatementHandler(StatementHandler statementHandler) {
        statementHandler = realTarget(statementHandler);
        MetaObject object = SystemMetaObject.forObject(statementHandler);
        return new MybatisStatementHandler(SystemMetaObject.forObject(object.getValue("delegate")));
    }
